...
The working encoding assigns one octet to each control field and eight octets to each address, producing a 20-octet header. This byte allocation can change before version 1 without changing the architectural decision.
