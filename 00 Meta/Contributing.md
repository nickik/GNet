...
4. For packet changes, update the packet document, relevant registry, and eventual golden vectors. A baseline physical flit diagram MUST show `2-bit VCID + 32 carried bits`; logical 32-bit protocol rows MUST be labelled `Word`, not `Flit`.
